...
func request_AliveService_GetStatus_0(ctx context.Context, marshaler runtime.Marshaler, client AliveServiceClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq Empty
...
func RegisterAliveServiceHandlerFromEndpoint(ctx context.Context, mux *runtime.ServeMux, endpoint string, opts []grpc.DialOption) (err error) {
	...
	return RegisterAliveServiceHandler(ctx, mux, conn)
}
...
func RegisterAliveServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client AliveServiceClient) error {
	...
	mux.Handle("GET", pattern_AliveService_GetStatus_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		resp, md, err := request_AliveService_GetStatus_0(rctx, inboundMarshaler, client, req, pathParams)
...
var (
	forward_AliveService_GetStatus_0 = runtime.ForwardResponseMessage
)
